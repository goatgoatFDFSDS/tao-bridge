...
// ─── ERC20 base for LP tokens ────────────────────────────────────────────────

contract UniswapV2ERC20 {
    using SafeMath for uint;

    string public constant name = 'TAOflow LP';
    string public constant symbol = 'TFLOW-LP';
    ...
    function approve(address spender, uint value) external returns (bool) { _approve(msg.sender, spender, value); return true; }
